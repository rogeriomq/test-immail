    ...
    <li className="text-lg border rounded-lg border-gray-800 bg-gray-800 relative p-3 text-white">
      ...
      <div className="my-2">
        <p className="text-lg flex items-center">
          <GiConvergenceTarget size={22} className="text-red-700 font-bold mr-2"/>
      ...
      <div className="my-3 flex items-center">
        <GiOverkill size={24} />
        <span className="font-semibold mx-1">Total kills: {game.total_kills}</span>
      </div>
      <p className="border-b border-white w-full"></p>
